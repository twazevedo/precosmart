/**
 * @file catalog.js — PreçoSmart Bot v2.0
 * @description Catálogo expandido: 15 produtos eletrônicos, 8 cupons ativos,
 * motor de ranking por desconto real (vs. histórico 30 dias) e links de afiliado.
 */
'use strict';
...
const COUPONS = [
  ...
  { code: 'SHOPEE50',     store: 'Shopee',        discount: 50,   type: 'fixed',   desc: '-R$\u00a050 acima de R$\u00a0300 (primeiros 100)'  },
  { code: 'AMZNWELCOME',  store: 'Amazon',        discount: 0.05, type: 'percent', desc: '-5% extra para novos clientes Prime'     }
];

// ── Catálogo de Produtos (15 eletrônicos) ────────────────────────────────────
const PRODUCTS = [
  {
    id: 'rtx-4060',     emoji: '🎮',
    ...
    quotes: [
      { store: 'KaBuM!',        pix: 1899.90, card: 2199.90 },
      { store: 'AliExpress',    pix: 1949.00, card: 2090.00 },
      { store: 'Mercado Livre', pix: 1999.00, card: 2149.00 },
      { store: 'Amazon',        pix: 2049.00, card: 2049.00 },
      { store: 'Shopee',        pix: 2099.00, card: 2249.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'KaBuM!',        pix: 4699.90, card: 5199.90 },
      { store: 'Mercado Livre', pix: 4749.00, card: 4999.00 },
      { store: 'Shopee',        pix: 4799.00, card: 4999.00 },
      { store: 'Amazon',        pix: 4899.00, card: 4899.00 },
      { store: 'AliExpress',    pix: 5120.00, card: 5390.00 }
    ],
    shipping: { 'KaBuM!': 'Entrega Ninja (1-2 dias)', 'Amazon': 'Prime Grátis', 'Mercado Livre': 'Full ML (Amanhã)', 'Shopee': 'Frete Grátis', 'AliExpress': 'Remessa Conforme' }
  },
  {
    ...
    quotes: [
      { store: 'Shopee',        pix: 3499.00, card: 3799.00 },
      { store: 'Amazon',        pix: 3599.00, card: 3599.00 },
      { store: 'Mercado Livre', pix: 3649.00, card: 3849.00 },
      { store: 'KaBuM!',        pix: 3699.90, card: 3999.90 },
      { store: 'AliExpress',    pix: 3890.00, card: 4120.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 2499.00, card: 2499.00 },
      { store: 'Mercado Livre', pix: 2549.00, card: 2699.00 },
      { store: 'Shopee',        pix: 2599.00, card: 2799.00 },
      { store: 'KaBuM!',        pix: 2699.90, card: 2999.90 },
      { store: 'AliExpress',    pix: 2890.00, card: 3090.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'KaBuM!',        pix: 1099.90, card: 1249.90 },
      { store: 'Mercado Livre', pix: 1189.00, card: 1249.00 },
      { store: 'Shopee',        pix: 1199.00, card: 1299.00 },
      { store: 'Amazon',        pix: 1249.00, card: 1249.00 },
      { store: 'AliExpress',    pix: 1290.00, card: 1390.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'AliExpress',    pix: 289.00,  card: 309.00  },
      { store: 'Shopee',        pix: 319.00,  card: 339.00  },
      { store: 'KaBuM!',        pix: 349.90,  card: 379.90  },
      { store: 'Mercado Livre', pix: 359.00,  card: 389.00  },
      { store: 'Amazon',        pix: 379.00,  card: 379.00  }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'KaBuM!',        pix: 2199.90, card: 2499.90 },
      { store: 'Shopee',        pix: 2249.00, card: 2499.00 },
      { store: 'Amazon',        pix: 2299.00, card: 2299.00 },
      { store: 'Mercado Livre', pix: 2349.00, card: 2499.00 },
      { store: 'AliExpress',    pix: 2490.00, card: 2690.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 1299.00, card: 1299.00 },
      { store: 'KaBuM!',        pix: 1349.90, card: 1499.90 },
      { store: 'Mercado Livre', pix: 1399.00, card: 1499.00 },
      { store: 'Shopee',        pix: 1449.00, card: 1549.00 },
      { store: 'AliExpress',    pix: 1480.00, card: 1590.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 5799.00, card: 5799.00 },
      { store: 'Mercado Livre', pix: 5899.00, card: 6199.00 },
      { store: 'KaBuM!',        pix: 5999.90, card: 6499.90 },
      { store: 'Shopee',        pix: 6099.00, card: 6399.00 },
      { store: 'AliExpress',    pix: 6250.00, card: 6590.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 3499.00, card: 3499.00 },
      { store: 'KaBuM!',        pix: 3599.90, card: 3999.90 },
      { store: 'Mercado Livre', pix: 3699.00, card: 3999.00 },
      { store: 'Shopee',        pix: 3799.00, card: 3999.00 },
      { store: 'AliExpress',    pix: 3999.00, card: 4199.00 }
    ],
    shipping: { 'Amazon': 'Prime Grátis', 'KaBuM!': 'Entrega Ninja (1-2 dias)', 'Mercado Livre': 'Full ML (Amanhã)', 'Shopee': 'Frete Grátis', 'AliExpress': 'Remessa Conforme' }
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 1549.00, card: 1549.00 },
      { store: 'Mercado Livre', pix: 1649.00, card: 1799.00 },
      { store: 'KaBuM!',        pix: 1699.90, card: 1899.90 },
      { store: 'Shopee',        pix: 1749.00, card: 1899.00 },
      { store: 'AliExpress',    pix: 1890.00, card: 1990.00 }
    ],
    shipping: { 'Amazon': 'Prime Grátis', 'Mercado Livre': 'Full ML (Amanhã)', 'KaBuM!': 'Entrega Ninja (1-2 dias)', 'Shopee': 'Frete Grátis', 'AliExpress': 'Remessa Conforme' }
  },
  {
    ...
    quotes: [
      { store: 'AliExpress',    pix: 1099.00, card: 1199.00 },
      { store: 'KaBuM!',        pix: 1149.90, card: 1299.90 },
      { store: 'Shopee',        pix: 1199.00, card: 1299.00 },
      { store: 'Amazon',        pix: 1249.00, card: 1249.00 },
      { store: 'Mercado Livre', pix: 1299.00, card: 1399.00 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'AliExpress',    pix: 4799.00, card: 5099.00 },
      { store: 'Shopee',        pix: 4999.00, card: 5299.00 },
      { store: 'Mercado Livre', pix: 5199.00, card: 5499.00 },
      { store: 'Amazon',        pix: 5399.00, card: 5399.00 },
      { store: 'KaBuM!',        pix: 5499.90, card: 5799.90 }
    ],
  ...
  },
  {
    ...
    quotes: [
      { store: 'Amazon',        pix: 1199.00, card: 1199.00 },
      { store: 'Mercado Livre', pix: 1299.00, card: 1399.00 },
      { store: 'Shopee',        pix: 1349.00, card: 1499.00 },
      { store: 'KaBuM!',        pix: 1399.90, card: 1549.90 },
      { store: 'AliExpress',    pix: 1450.00, card: 1590.00 }
    ],
  ...
  {
    id: 'action-cam-gopro13', emoji: '🎥',
    title: 'Câmera de Ação GoPro HERO 13 Black 5.3K',
    category: 'Câmeras & Drones',
    history30dAvg: 2649, history30dMin: 2999,
    quotes: [
      { store: 'Amazon',        pix: 2299.00, card: 2299.00 },
      { store: 'KaBuM!',        pix: 2399.90, card: 2699.90 },
      { store: 'Mercado Livre', pix: 2499.00, card: 2699.00 },
      { store: 'Shopee',        pix: 2599.00, card: 2799.00 },
      { store: 'AliExpress',    pix: 2699.00, card: 2899.00 }
    ],
    shipping: { 'Amazon': 'Prime Grátis', 'KaBuM!': 'Entrega Ninja (1-2 dias)', 'Mercado Livre': 'Full ML (Amanhã)', 'Shopee': 'Frete Grátis', 'AliExpress': 'Remessa Conforme' }
  }
];
...
/** URL de afiliado para cada loja */
...
/** Melhor cupom disponível para a loja mais barata */
...
/** Top N produtos com maior desconto real (vs. média 30 dias) */
...
/** Produto do dia (determinístico por data) */
...
/** Produto aleatório (diferente de `excludeId`) */
function getRandomProduct(excludeId = null) {
  const pool = excludeId ? PRODUCTS.filter((p) => p.id !== excludeId) : PRODUCTS;
  return pool[Math.floor(Math.random() * pool.length)];
}

module.exports = { PRODUCTS, COUPONS, AFFILIATE, getAffiliateUrl, getBestCoupon, getTopDeals, getDailyProduct, getRandomProduct };
